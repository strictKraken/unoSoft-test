...
import { authVK } from "@/api/vk/auth";
const handleClick = () => {
  authVK();
};
</script>
...
<template>
  <button @click="handleClick" id="VKIDSDKAuthButton" class="VkIdWebSdk__button VkIdWebSdk__button_reset">
    <div class="VkIdWebSdk__button_container">
      ...
      <div class="VkIdWebSdk__button_text">Sing in VK</div>
    </div>
  </button>
</template>
